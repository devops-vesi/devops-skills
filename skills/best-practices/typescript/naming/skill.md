---
name: naming
description: Use when naming or renaming variables, functions, classes or interfaces in TypeScript code. 
when_to_use: |
...
Using camelCase for variable and function names can improve code readability and maintainability by following a consistent naming convention. This convention is widely adopted in the TypeScript community and helps distinguish variables and functions from other types of identifiers.
...
Using PascalCase for class and interface names can improve code readability and maintainability by following a consistent naming convention. This convention is widely adopted in the TypeScript community and helps distinguish classes and interfaces from other types of identifiers.
